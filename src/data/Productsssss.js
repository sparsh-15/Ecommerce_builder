...
export const products = [
  {
    ...
    images: [
      ...
      "https://m.media-amazon.com/images/I/81c+9BOQNWL._AC_UF1000,1000_QL80_.jpg",
      "https://m.media-amazon.com/images/I/61zKGsIdAjL._AC_UF1000,1000_QL80_.jpg"
    ],
    category: "audio-devices",
    rating: 4.8,
    reviews: 1247,
    ratingDistribution: { 5: 0.82, 4: 0.13, 3: 0.03, 2: 0.01, 1: 0.01 },
    inStock: true,
    isNew: true,
    isFeatured: true,
    discount: 14,
    ...
    inTheBox: ["Headphones", "Carrying Case", "Charging Cable", "User Manual"],
    specifications: [
    ...
    reviews: [
      {
        ...
        content: "Amazing sound and noise cancellation. Worth the price!",
        date: "2023-10-15",
        images: ["https://m.media-amazon.com/images/I/81c+9BOQNWL._AC_UF1000,1000_QL80_.jpg"]
      },
      {
        id: 2,
        user: "Priya S.",
        rating: 4,
        title: "Very Good",
        content: "Comfortable and sounds great. Just a bit expensive.",
        date: "2023-11-02",
        images: []
      }
    ],
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1717865499857-ec35ce6e65fa?q=80&w=1925&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    category: "laptops",
    rating: 4.7,
    reviews: 567,
    inStock: true,
