      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {features.map((feat, idx) => (
            <div 
              key={idx} 
              className="group relative bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 ease-in-out transform hover:-translate-y-1"
            >
              ...
              <div className="relative">
                <div className="flex justify-center items-center w-16 h-16 mx-auto mb-6 rounded-full bg-blue-100 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
                  {feat.icon}
                </div>
